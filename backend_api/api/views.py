...
from api.serializer import MyTokenObtainPairSerializer, RegisterSerializer, RegisterSerializerActividad, TipoEventoActividadSerializer, ActividadSerializer
...
from api.serializer import TipoEventoSerializer
...
class ActividadViewAcr(generics.ListAPIView):
    queryset = Actividad.objects.all()
    permission_classes = (AllowAny,)
